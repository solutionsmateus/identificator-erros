...
def unzip_folders(folder_path: str):
    """
    Encontra e descompacta todos os arquivos .zip em um diretório e seus subdiretórios.
    """
...
def validate_spreadsheet(df: pd.DataFrame) -> bool:
    """
    Executa uma série de validações no DataFrame.
    Retorna True se passar, False se falhar.
    """
